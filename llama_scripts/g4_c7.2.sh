...
CUDA_VISIBLE_DEVICES=7 python src/main.py --model qwen2.5-7b --num_agents 5 --data arithmetics --data_size 100 --debate_rounds 5 --sparse
CUDA_VISIBLE_DEVICES=7 python src/main.py --model qwen2.5-7b --num_agents 5 --data arithmetics --data_size 100 --debate_rounds 5 --centralized