...
for method in ['zlib','zlibfsd','avgperplexity','avgperplexityfsd','min20prob','min20probfsd','min20plusprob','min20plusprobfsd','kd_sqrt','aed','acs']:
    try:
...
conts = conts[:len(score_list['kd_sqrt'])]
